...
void gnss_init_setup(const GNSS_INIT_MODE_T* init_mode_p );
#else
void gnss_init( void );
void gnss_init_setup(void);
#endif
...
S16 gv8_get_gga(char* buf_p);
S16 gv8_get_gll(char* buf_p);
S16 gv8_get_GPS_gsa(char* buf_p);
S16 gv8_get_GLONASS_gsa(char* buf_p);
S16 gv8_get_GPS_gsv(U08 sentence, char* buf_p);
S16 gv8_get_GLONASS_gsv(U08 sentence, char* buf_p);
S16 gv8_get_rmc(char* buf_p);
S16 gv8_get_vtg(char* buf_p);
S16 gv8_get_zda( char* buf_p);
S16 gv8_get_BD_gsa(char* buf_p);
S16 gv8_get_BD_gsv(U08 sentence, char* buf_p);
