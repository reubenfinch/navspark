...
public:
	...
	void setMessageInterval(uint8_t gga_intv, uint8_t gll_intv, uint8_t gsa_intv, uint8_t gsv_intv, uint8_t rmc_intv, uint8_t vtg_intv, uint8_t zda_intv);
	void getMessageInterval(uint8_t* gga_intv, uint8_t* gll_intv, uint8_t* gsa_intv, uint8_t* gsv_intv, uint8_t* rmc_intv, uint8_t* vtg_intv, uint8_t* zda_intv);
	void init(void);
	void setup(void);
	bool init_done(void);
};
...
public:
	...
	int getGgaSentence(char* buf_p);
	int getGllSentence(char* buf_p);
	int getGpGsaSentence(char* buf_p);
	int getGpGsvSentence(uint8_t sentence, char* buf_p);
	int getGlGsaSentence(char* buf_p);
	int getGlGsvSentence(uint8_t sentence, char* buf_p);
	int getBdGsaSentence(char* buf_p);
	int getBdGsvSentence(uint8_t sentence, char* buf_p);
	int getRmcSentence(char* buf_p);
	int getVtgSentence(char* buf_p);
	int getZdaSentence(char* buf_p);
