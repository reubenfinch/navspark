...
extern void itoa(int n, char* buffer, unsigned char base);
extern void utoa(unsigned int n, char* buffer, unsigned char base);
...
extern void dtostr(double value, char* buf, unsigned char decimalPlaces);
