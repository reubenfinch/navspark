...
class TwoWire : public Stream
{
	private:
		...
		static uint8_t	_mode;	// 1 for master, 0 for slave
		...
		sTwoWireBuffer	recv;
		pTwoWireBuffer	pRecv;
		sTwoWireBuffer	xmit;
		pTwoWireBuffer	pXmit;
