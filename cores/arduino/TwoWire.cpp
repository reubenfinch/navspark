...
// **********************************************************************
TwoWire_MasterSlave twMaster = TwoWire_MasterSlave(TWOWIRE_MASTER);
TwoWire_MasterSlave twSlave  = TwoWire_MasterSlave(TWOWIRE_SLAVE);
...
// **********************************************************************
TwoWire_MasterSlave::TwoWire_MasterSlave(void)
{
	TwoWire_MasterSlave(TWOWIRE_MASTER);
}

TwoWire_MasterSlave::TwoWire_MasterSlave(uint8_t mode)
{
	_mode = mode;
	_devAddr = 0x3c;
	_txAddr = 0x00;
...
// **********************************************************************
void TwoWire_MasterSlave::config(uint32_t clkRate)
{
...
uint32_t TwoWire_MasterSlave::getClkRate(void)
{
	return _clkRate;
}
...
// **********************************************************************
bool TwoWire_MasterSlave::setBufferSize(uint16_t xmitSize, uint16_t recvSize)
{
	uint8_t *newXmitPtr;
	uint8_t *newRecvPtr;
...
void TwoWire_MasterSlave::reset(void)
{
	this->resetTx();
	this->resetRx();
}

void TwoWire_MasterSlave::resetTx(void)
{
	pXmit->wrPtr = 0;
...
void TwoWire_MasterSlave::resetRx(void)
{
	pRecv->wrPtr = 0;
...
// **********************************************************************
void TwoWire_MasterSlave::begin(void)
{
...
void TwoWire_MasterSlave::begin(uint8_t addr)
{
...
// **********************************************************************
void TwoWire_MasterSlave::setTransmitDeviceAddr(uint8_t addr)
{
	if (_mode == TWOWIRE_MASTER) {
...
void TwoWire_MasterSlave::setReceiveDeviceAddr(uint8_t addr)
{
	if (_mode == TWOWIRE_MASTER) {
...
// Added by Andrew
void TwoWire_MasterSlave::beginTransmission(uint8_t address)
{
  twMaster.reset();
  twMaster.setTransmitDeviceAddr(address);
  twMaster.setReceiveDeviceAddr(address);
}

// Added by Andrew
void TwoWire_MasterSlave::beginTransmission(int address)
{
...
// **********************************************************************
uint16_t TwoWire_MasterSlave::endTransmission(bool xmitStop)
{
	uint16_t byteXmit = 0;
...
uint16_t TwoWire_MasterSlave::endTransmission(void)
{
...
// **********************************************************************
uint16_t TwoWire_MasterSlave::readDeviceFromOffset(uint8_t devOffset, uint16_t quantity, bool xmitStop)
{
...
uint16_t TwoWire_MasterSlave::readDevice(uint16_t quantity, bool xmitStop)
{
	uint16_t byteToRead;
	uint16_t byteRecv = 0;
...
uint16_t TwoWire_MasterSlave::readDevice(uint16_t quantity)
{
	return readDevice(quantity, true);
}

// Added by Andrew
uint8_t TwoWire_MasterSlave::requestFrom(uint8_t address, uint8_t quantity, uint8_t sendStop)
{
    uint16_t byteToRead;
	uint16_t byteRecv = 0;
	...
	if (_mode == TWOWIRE_MASTER) {
		byteToRead = (quantity > pRecv->numSpace) ? pRecv->numSpace : quantity;
		byteRecv = v8_i2c_master_read(address, &pRecv->buffer[pRecv->wrPtr], byteToRead, sendStop);
		pRecv->wrPtr += byteRecv;
		pRecv->numSpace -= byteRecv;
		pRecv->numData += byteRecv;
	}
...
// Added by Andrew
uint8_t TwoWire_MasterSlave::requestFrom(uint8_t address, uint8_t quantity)
{
  return requestFrom((uint8_t)address, (uint8_t)quantity, (uint8_t)true);
}

// Added by Andrew
uint8_t TwoWire_MasterSlave::requestFrom(int address, int quantity)
{
  return requestFrom((uint8_t)address, (uint8_t)quantity, (uint8_t)true);
}

// Added by Andrew
uint8_t TwoWire_MasterSlave::requestFrom(int address, int quantity, int sendStop)
{
...
// **********************************************************************
size_t TwoWire_MasterSlave::write(uint8_t data)
{
...
size_t TwoWire_MasterSlave::write(uint8_t *data, size_t size)
{
	uint32_t	i, k;
...
void TwoWire_MasterSlave::send(uint8_t data)
{
	write(data);
}

void TwoWire_MasterSlave::send(uint8_t *data, size_t size)
{
	write(data, size);
}

size_t TwoWire_MasterSlave::writeAtOffset(uint8_t devOffset, uint8_t *data, size_t size)
{
	uint32_t i;
	uint16_t k;
...
// **********************************************************************
size_t TwoWire_MasterSlave::available(void)
{
	return ((size_t)pRecv->numData);
}

// **********************************************************************
// Description: Return how many bytes of free space in ingress buffer
// **********************************************************************
size_t TwoWire_MasterSlave::recv_space(void)
{
	return ((size_t)(pRecv->numSpace));
}

// **********************************************************************
// Description: Return how many bytes of egress data still in Tx buffer
// **********************************************************************
size_t TwoWire_MasterSlave::remaining(void)
{
	return ((size_t)pXmit->numData);
}

// **********************************************************************
// Description: Return how many bytes of free space in egress buffer
// **********************************************************************
size_t TwoWire_MasterSlave::xmit_space(void)
{
	return ((size_t)(pXmit->numSpace ));
}

// **********************************************************************
// Description: Read out the data received in buffer
// **********************************************************************
int TwoWire_MasterSlave::read(void)
{
	int value = -1;
	uint8_t	data;
...
size_t TwoWire_MasterSlave::blk_read(uint8_t *dst, size_t size)
{
  unsigned int k;
  unsigned int num;
...
// **********************************************************************
int TwoWire_MasterSlave::peek(void)
{
	int value = -1;
	uint8_t	data;
...
// Description:
// **********************************************************************
void TwoWire_MasterSlave::flush(void)
{
...
// **********************************************************************
#if 1
void TwoWire_MasterSlave::onReceive( void (*function)(void) )
{
	if (_mode == TWOWIRE_SLAVE) {
...
// **********************************************************************
#if 1
void TwoWire_MasterSlave::onRequest( void (*function)(void) )
{
	if (_mode == TWOWIRE_SLAVE) {
...
//
void TwoWire_MasterSlave::isr(void)
{
	uint8_t	i;
	uint8_t tx_num = 0;
	uint8_t rx_num = 0;
...
// Description:
// **********************************************************************
TwoWire_MasterSlave::operator bool() {
	return enabled;
}
