...
void GNSSParam::setMessageInterval(uint8_t gga_intv, uint8_t gll_intv, uint8_t gsa_intv, uint8_t gsv_intv, uint8_t rmc_intv, uint8_t vtg_intv, uint8_t zda_intv)
{
	init_mode.nmea_interval.gga_t = gga_intv;
	init_mode.nmea_interval.gll_t = gll_intv;
	init_mode.nmea_interval.gsa_t = gsa_intv;
	init_mode.nmea_interval.gsv_t = gsv_intv;
	init_mode.nmea_interval.rmc_t = rmc_intv;
	init_mode.nmea_interval.vtg_t = vtg_intv;
	init_mode.nmea_interval.zda_t = zda_intv;
}

void GNSSParam::getMessageInterval(uint8_t* gga_intv, uint8_t* gll_intv, uint8_t* gsa_intv, 
								   uint8_t* gsv_intv, uint8_t* rmc_intv, uint8_t* vtg_intv, 
								   uint8_t* zda_intv)
{
#if defined(USE_UART1_FOR_NMEA) && (USE_UART1_FOR_NMEA==1)
	gnss_get_NMEA_interval(gga_intv, gll_intv, gsa_intv, gsv_intv, rmc_intv, vtg_intv, zda_intv);
#endif
}

void GNSSParam::init(void)
{
  if(this->_init_done == true)
  return;
...
void GNSSParam::setup(void)
{
  
	// system-wide initialization
#if defined(USE_UART1_FOR_NMEA) && (USE_UART1_FOR_NMEA==1)
	gnss_init_setup(&(this->init_mode));
#else
	gnss_init_setup();
#endif
...
int GNSS::getGgaSentence(char* buf_p)
{
	return gv8_get_gga(buf_p);
}

int GNSS::getGllSentence(char* buf_p)
{
	return gv8_get_gll(buf_p);
}

int GNSS::getGpGsaSentence(char* buf_p)
{
	return gv8_get_GPS_gsa(buf_p);
}

int GNSS::getGpGsvSentence(uint8_t sentence, char* buf_p)
{
	return gv8_get_GPS_gsv(sentence, buf_p);
}

int GNSS::getGlGsaSentence(char* buf_p)
{
#if defined(ST_CONST_SEL) && (ST_CONST_SEL==3)
	return gv8_get_GLONASS_gsa(buf_p);
#else
	return 0;
#endif
}

int GNSS::getGlGsvSentence(uint8_t sentence, char* buf_p)
{
#if defined(ST_CONST_SEL) && (ST_CONST_SEL==3)
	return gv8_get_GLONASS_gsv(sentence, buf_p);
#else
	return 0;
#endif
}

int GNSS::getBdGsaSentence(char* buf_p)
{
#if defined(ST_CONST_SEL) && (ST_CONST_SEL==2 || ST_CONST_SEL==4)
	return gv8_get_BD_gsa(buf_p);
#else
	return 0;
#endif
}

int GNSS::getBdGsvSentence(uint8_t sentence, char* buf_p)
{
#if defined(ST_CONST_SEL) && (ST_CONST_SEL==2 || ST_CONST_SEL==4)
	return gv8_get_BD_gsv(sentence, buf_p);
#else
	return 0;
#endif
}

int GNSS::getRmcSentence(char* buf_p)
{
	return gv8_get_rmc(buf_p);
}

int GNSS::getVtgSentence(char* buf_p)
{
	return gv8_get_vtg(buf_p);
}

int GNSS::getZdaSentence(char* buf_p)
{
	return gv8_get_zda(buf_p);
}
